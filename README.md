...
✅ Система «Управление недвижимостью» на Laravel + Orchid: иерархия ЖК → здания → секции → этажи → помещения, удобная админ‑панель с дашбордом и фильтрами, история изменений статусов/цен, кэширование (Redis) и REST API для интеграции. https://github.com/GLM-Alyona/real-estate-management-system   
✅ Реализация кастомного типа записей "Доктора" с архивом, фильтрацией и сортировкой WP https://github.com/GLM-Alyona/wp-site   
